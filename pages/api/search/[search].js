...
export default withSession(async (req, res) => {
  ...
  const {sort,state,city,type,street,search_data,searchfilter,searchFilter,agent,page,status} =  req.query
...
return returnData
  ...
  const options = {
    ...
    search:{
      value:search_data,
      fields: getField(searchFilter ?searchFilter : searchfilter)
    },
    select:"title status type location price duration images agentuser likes views condition",
    populate:"agentuser"
  }
  ...
  const categoryOptions = {
    ...
    search:{
      value:search_data,
      fields:['title','type','status','duration','condition']
    },
    select:"title status type location price duration images agentuser likes views condition",
    populate:"agentuser"
  }
...
property =  await Property.paginate({},categoryOptions)
console.log('search-Filter',searchFilter)

    }    else {

property =  await Property.paginate({type:searchFilter.replace("and",'&')},options)
